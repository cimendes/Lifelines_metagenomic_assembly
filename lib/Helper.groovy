class Help {
    ...
    static def print_help(Map params) {
        ...
        println "       "
        println "       Component 'MAXBIN2_3_6'"
        println "       -----------------------"
        println "       --min_contig_lenght_3_6     minimum contig length. Default: 1000 (default: 1000)"
        println "       --max_iteration_3_6         maximum Expectation-Maximization algorithmiteration number. Default: 50 (default: 50)"
        println "       --prob_threshold_3_6        probability threshold for EM final classification.Default: 0.9 (default: 0.9)"
        println "       --clearInput_3_6            Permanently removes temporary input files. This option is only useful to remove temporary files in large workflows and prevents nextflow's resume functionality. Use with caution. (default: false)"
        println "       "
        println "       Component 'MASH_DIST_4_7'"
        println "       -------------------------"
        println "       --pValue_4_7                P-value cutoff for the distance estimation between two sequences to be included in the output. (default: 0.05)"
        println "       --mash_distance_4_7         Sets the maximum distance between two sequences to be included in the output. (default: 0.1)"
        println "       --shared_hashes_4_7         Sets a minimum percentage of hashes shared between two sequences in order to include its result in the output. (default: 0.8)"
        println "       --refFile_4_7               Specifies the reference file to be provided to mash. It can either be a fasta or a .msh reference sketch generated by mash. (default: '/ngstools/data/plasmid_db_reference.msh')"
        println "       "
        println "       Component 'MLST_5_8'"
        println "       --------------------"
        println "       --mlstSpecies_5_8           Specify the expected species for MLST checking. (default: null)"
        println "       "
        println "       Component 'KRAKEN2_FASTA_6_9'"
        println "       -----------------------------"
        println "       --kraken2DB_6_9             Specifies kraken2 database. Requires full path if database not on KRAKEN2_DB_PATH. (default: 'minikraken2_v1_8GB')"
        println "       "
        println "       Component 'ABRICATE_7_10'"
        println "       -------------------------"
        println "       --abricateDatabases_7_10    Specify the databases for abricate. (default: ['resfinder', 'card', 'vfdb', 'plasmidfinder', 'virulencefinder', 'bacmet'])"
        println "       --abricateDataDir_7_10      Specify the full path location of the database folders. (default: null)"
        println "       --abricateMinId_7_10        Minimum DNA %identity. (default: 75)"
        println "       --abricateMinCov_7_10       Minimum DNA %coverage. (default: 0)"
